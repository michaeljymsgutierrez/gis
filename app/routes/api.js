...
module.exports = function(router) {
    ...
    router.post('/users', function(req, res) {
        ...
        user.address = require.body.address;
        ...
        if (req.body.businessname === null || req.body.businessname === '' || req.body.address === null || req.body.address === '' ||  req.body.username === null || req.body.username === '' || req.body.password === null || req.body.password === '' || req.body.email === null || req.body.email === '' || req.body.name === null || req.body.name === '') {
            ...
            user.save(function(err) {
                if (err) {
                    ...
                    if (err.errors !== null) {
                        if (err.errors.businessname) {
                            res.json({ success: false, message: err.errors.businessname.message }); // Display error in validation (name)
                        }else if (err.errors.address) {
                                res.json({ success: false, message: err.errors.address.message }); // Display error in validation (name)
                ...
                let mailOptions = {
                    ...
                    to: [user.email, 'jeremy.ramoso16@gmail.com'],
                    ...
                    if (err) {
                        ...
                        user.save(function(err) {
                            if (err) {
                                ...
                                let mailOptions = {
                                    from: 'Mail from animal Surveillance System, jeremyrbinuya@gmail.com',
                                    to: user.email,
